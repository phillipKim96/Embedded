...
<%
    ...
    try{
        ...
        while(rs.next() == true) {
            ...
            resultuserip = rs.getString("user_ip");
            resultDate = rs.getString("date");
            resultUserID = rs.getString("nickname");
            jobj.put("id", resultId);
            jobj.put("text", resultText);
            jobj.put("user_ip", resultuserip);
            jobj.put("date", resultDate);
            jobj.put("nickname", resultUserID);
